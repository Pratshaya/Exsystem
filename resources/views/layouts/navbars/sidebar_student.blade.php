<div class="sidebar" data-color="orange" data-background-color="white"
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            Auth::user()->hasRole('admincampus')||Auth::user()->hasRole('adminfaculty')||
            ...
            <li class="nav-item {{ ($activePage == 'category') ? ' active' : '' }}">
                    ...
                    <div class="collapse {{ ($activePage == 'category')||($activePage == 'quiz')||($activePage == 'question') ? ' show' : '' }}"
                         id="laravelExample">
                        <ul class="nav">
                            <li class="nav-item{{ $activePage == 'category' ? ' active' : '' }}">
                                <a class="nav-link" href="{{ route('category.index') }}">
            ...
            <li class="nav-item {{ ($activePage == 'category_q') ? ' active' : '' }}">
                ...
                <div class="collapse {{ ($activePage == 'category_q')||($activePage == 'questionnaire')||($activePage == 'questionnaire_mng') ? ' show' : '' }}"
                     id="laravelExample2">
                    <ul class="nav">
                        <li class="nav-item{{ $activePage == 'category_q' ? ' active' : '' }}">
            ...
            <li class="nav-item{{ $activePage == 'manager' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('managepage') }}">
                    <i class="material-icons">aspect_ratio</i>
                    <p>{{ __('การจัดการเกี่ยวกับภายใน') }}</p>
                </a>
            </li>
